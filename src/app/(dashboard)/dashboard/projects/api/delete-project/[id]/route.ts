...
// DELETE API:: delete single project
export const DELETE = async (
  ...
  try {
    ...
    const res = await db.collection("projects").deleteOne({ _id: objectId });
    ...
    console.error("Error deleting proejct:", error);
    return NextResponse.json(
      { message: "Failed to delete proejct", error },
      { status: 500 }
    );
  }
};
